 ...
 */
public class FieldWriteAccess extends Expr {
	int opcode;

	protected FieldWriteAccess(int pos, CodeIterator i, CtClass declaring,
							MethodInfo m, int op) {
	...
	/**
	 * Returns the list of exceptions that the expression may throw. This list includes both the exceptions that the
	 * try-catch statements including the expression can catch and the exceptions that the throws declaration allows the
	 * method to throw.
	 */
	@Override
	...
	/**
	 * Returns the signature of the field type. The signature is represented by a character string called field
	 ...
	 * 
	 * <p>
	 * $0 is available even if the called method is static. If the field access is writing, $_ is available but the
	 * value of $_ is ignored.
	 * 
	 * @param statement
