...
public class ValueExpTest {
	...
	public void testValueExpForClass() {
		assertEquals("de.andrena.next.internal.compiler.ValueExpTest.class", new ValueExp(getClass()).getCode());
	}

	@Test
	public void testValueExpForCtClass() throws Exception {
		CtClass clazz = ClassPool.getDefault().get(getClass().getName());
		assertEquals("de.andrena.next.internal.compiler.ValueExpTest.class", new ValueExp(clazz).getCode());
	}
	...
	public void testValueExpForEnum() {
		assertEquals("de.andrena.next.internal.compiler.ValueExpTest$SampleEnum.ENUM_VALUE", new ValueExp(
				SampleEnum.ENUM_VALUE).getCode());
	}
